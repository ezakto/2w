...
(function (window) {
    ...
    $2w.prototype.controller = function (id, cb){
        return typeof cb === 'undefined' ? this._controller(id).$scope : this._controller(id, cb);
    };
    ...
    /**
     * map quick polyfill (just functionality needed in this lib)
     * @param  {Function}   cb  Callback
     * @param  {Mixed}      th  this argument for callback
     */
